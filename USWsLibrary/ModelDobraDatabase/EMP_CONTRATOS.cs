...
namespace USWsLibrary.ModelDobraDatabase
{
    ...
    public partial class EMP_CONTRATOS
    {
        ...
        public Nullable<decimal> Remuneración { get; set; }
        public string Lugar_Labores { get; set; }
        public string Nota { get; set; }
        public string DivisiónID { get; set; }
        public string Empleador { get; set; }
        public string Representante { get; set; }
        public string Domicilio_Empleador { get; set; }
