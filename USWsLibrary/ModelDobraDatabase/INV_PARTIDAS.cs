...
namespace USWsLibrary.ModelDobraDatabase
{
    ...
    public partial class INV_PARTIDAS
    {
        public string ID { get; set; }
        public string Código { get; set; }
        public string Nombre { get; set; }
        public string Título1 { get; set; }
        public string Título2 { get; set; }
        public decimal tasaArancelaria { get; set; }
        public decimal FODINFA { get; set; }
        public decimal ICE { get; set; }
        public bool PagaIVA { get; set; }
        public bool NoPagaAdValorem { get; set; }
        ...
        public bool IsISDCosto { get; set; }
    }
}
